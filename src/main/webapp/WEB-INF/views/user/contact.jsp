...
<html lang="en">
  ...
  <body>
    ...
    <main>
            ...
            <div class="col">
              <div class="banner-common__content">
                ...
                <div class="banner-common__box">
                  ...
                  <a href="">
                    <p
                      class="banner-common_title-2 banner-common_title-2--active"
                    >
                      Liên Hệ
                    </p>
                  </a>
      ...
      <h1 class="heading-primary heading-primary--white">Liên Hệ</h1>
      <a href="">
        <p class="banner-common__title-2 banner-common__title-2--active">
          Liên Hệ
        </p>
      </a>
      <div class="contact">
          ...
          <div class="row justify-content-between">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
              ...
              >
                ...
                <button id="save" type="button" class="btn__sent">
                  Gửi tin(Ajax Normal Form)
                </button>
              ...
              >
                ...
                <button
                  type="button"
                  class="btn__sent"
                  onclick="checkName(),checkEmRegister(),checkSDT(),checkMessage(),send(),saveContact()"
                >
                  Gửi tin
                </button>
            ...
            <div class="col">
              ...
              <div class="map__photo">
                <div style="width: 100%">
                  ...
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7446.9760971350115!2d105.7344522911134!3d21.05316093510255!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313454f9de2328cf%3A0xc5685fbea9808d8e!2zTmd1ecOqbiBYw6EsIE1pbmggS2hhaSwgVOG7qyBMacOqbSwgSMOgIE7hu5lpLCBWaeG7h3QgTmFt!5e0!3m2!1svi!2s!4v1681386839077!5m2!1svi!2s"
                    width="100%"
                    height="600"
                    style="border: 0"
                    allowfullscreen=""
    ...
    <script>
      function checkEmRegister() {
        ...
        if (y3.test(g)) {
          ...
          document.getElementById("demo-email").innerHTML =
            "Note: Lưu ý định dạng email (abc@gmail.com).";
          return false;
        }
      }
      function checkName() {
        ...
        if (g == null || g == "") {
          ...
          document.getElementById("demo-name").innerHTML =
            "Note: Không được để trống trường này";
          return false;
        } else {
          document.getElementById("demo-name").innerHTML = "";
      ...
      function checkSDT() {
        ...
        if (g != null && g != "") {
          if (vnf_regex.test(g)) {
            document.getElementById("demo-phone").innerHTML = "";
            document.getElementById("numberphone").style.border =
              "1px solid gray";
            return true;
          } else {
            document.getElementById("numberphone").style.border =
              "1px solid red";
            document.getElementById("demo-phone").innerHTML =
              "Note: Số điện thoại không hợp lệ";
            return false;
          }
        }
      }
