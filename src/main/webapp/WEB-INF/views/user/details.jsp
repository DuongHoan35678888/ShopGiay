						...
						<div class="details__info" data-aos="fade-left" data-aos-delay="0">
							...
							<div class="details__select">
								<div class="details__number">
									<span class="details__number-minus"><i
										class="fas fa-minus"></i></span><span class="details__number-basket">1
									</span><span class="details__number-plus"> <i
										class="fas fa-plus"></i></span>
								</div>

								<button class="details__add-to-basket custom1"
									onclick="addToCart(${product.id},1)">Thêm vào giỏ</button>
